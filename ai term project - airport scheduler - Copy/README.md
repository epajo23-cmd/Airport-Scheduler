...
1. **Statistical Learning (Machine Learning)**  
   A classification model is trained on historical flight data to predict whether a flight will experience a **departure delay greater than 15 minutes**.
...
The dataset file flights.csv is included in the repository under:
data/flights.csv
